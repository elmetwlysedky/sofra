...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <Form action="{{route('setting.about.update')}}" class="form-validate-jquery" method="post" enctype="multipart/form-data">
                @csrf
                ...
                @foreach($data as $key => $value )
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea type="text" name="{{$key}}" class="form-control" >{{$value}} </textarea>
