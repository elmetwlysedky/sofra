...
<div class="card">
    ...
    <div class="card-body">
        ...
        <Form action="{{route('city.update',$city->id)}}" class="form-validate-jquery" method="post" enctype="multipart/form-data">
            @csrf
        ...
        @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="name" value="{{$city->name}}" class="form-control" placeholder="inter city name">
                </div>
            </div>
